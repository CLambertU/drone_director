...
访问 http://127.0.0.1:5173 ，点击“生成 100 机演示场景”，再点击“启动仿真”。默认后端端口 8011；如被占用可运行 .\scripts\run_demo.ps1 -BackendPort 8012 -FrontendPort 5174。退出脚本会停止本次启动的后端。单独启动后端用 .\scripts\run_backend.ps1，单独启动前端用 .\scripts\run_frontend.ps1，测试用 .\scripts\run_tests.ps1。
